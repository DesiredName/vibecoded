...
export const TOWER_DEFS = {
  basic:  { range: 3.0, damage: 15, fireRate: 1.0, splash: 0,   cost: 50,  color: 0x00aaff, emissive: 0x004488, label: 'Basic',  },
  sniper: { range: 6.0, damage: 60, fireRate: 0.4, splash: 0,   cost: 100, color: 0x9933ff, emissive: 0x441166, label: 'Sniper', },
  splash: { range: 2.5, damage: 20, fireRate: 0.7, splash: 1.2, cost: 150, color: 0xff6600, emissive: 0x883300, label: 'Splash', },
} as const;
