<template>
  <a
    ...
    class="group block rounded-xl bg-gray-900 border border-gray-800 overflow-hidden hover:border-amber-500/60 transition-all duration-200 hover:shadow-xl hover:shadow-amber-900/20 hover:-translate-y-0.5"
  >
